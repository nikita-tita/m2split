...
export const businessProcessContent: Record<string, ProcessContent> = {
  ...
  overview: {
    ...
    steps: [
      ...
      'Застройщик переводит единую комиссию КВН на номинальный счет М2',
      'М2 получает комиссию и удерживает сервисный сбор за обслуживание',
      ...
      'Участники предоставляют первичные документы М2 (акты, чеки НПД)',
    ...
    operations: {
      ...
      items: [
        ...
        'М2 → М2: удержание сервисного сбора за обслуживание платформы',
        'М2 → Участники: распределение комиссии по заранее согласованным долям',
        'Все операции проходят через номинальный счет М2 (застройщик не переводит напрямую АН или агентам)',
    ...
    accounts: {
      ...
      items: [
        'Номинальный счет М2 - единственный получатель комиссии от застройщиков',
        'Номинальный счет М2 - единственный плательщик для всех участников',
    ...
    documents: {
      ...
      items: [
        ...
        'Участники → М2: акты, счета-фактуры, чеки НПД после получения выплат',
        'М2 → Застройщику: сводный пакет (реестр + подтверждения банка + первичка)',
  ...
  dealCreation: {
    ...
    accounts: {
      ...
      items: [
        'Номинальный счет М2 - единственный получатель комиссии КВН от застройщика',
        'Номинальный счет М2 - единственный плательщик долей участникам',
  ...
  dealsList: {
    ...
    steps: [
      ...
      'В работе - объект забронирован, ожидается перевод комиссии от застройщика на счет М2',
      'В реестре - М2 получила комиссию, сделка включена в реестр на выплату участникам',
      'Выплачено - М2 распределила комиссию, все участники получили свои доли',
    ],
    operations: {
      ...
      items: [
        ...
        'Застройщик → М2: перевод комиссии КВН на номинальный счет М2',
        'Формирование реестра выплат участникам (статус: В реестре)',
        'М2 → Участники: выплата долей на расчетные счета (статус: Выплачено)',
      ],
    },
  },
  ...
  registryCreation: {
    ...
    description: 'Реестр выплат - это документ, который формирует оператор М2 для отправки в банк. В реестре собраны все выплаты, которые М2 должна произвести участникам сделок из полученных комиссий. М2 выступает единственным плательщиком - все выплаты идут с номинального счета М2.',
    steps: [
      'Оператор М2 получает комиссию КВН от застройщика на номинальный счет',
      ...
      'Банк исполняет платежи от имени М2 и возвращает статусы по каждой строке',
    ],
    operations: {
    ...
    accounts: {
      ...
      items: [
        'Номинальный счет М2 → Списание сумм согласно реестру (М2 - единственный плательщик)',
  ...
  payments: {
    ...
    accounts: {
      ...
      items: [
        'Номинальный счет М2 - контроль списаний (все платежи идут отсюда)',
  ...
  documents: {
    ...
    description: 'Для каждой выплаты от М2 участникам требуется первичная документация. Участники предоставляют М2 акты, счета-фактуры, чеки НПД на суммы полученных выплат. М2 собирает все документы и формирует сводные пакеты для застройщика, подтверждающие распределение комиссии.',
    steps: [
      'М2 производит выплаты участникам со своего номинального счета',
